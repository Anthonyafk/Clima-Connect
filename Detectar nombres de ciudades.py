...
# Entrada del usuario en minúsculas
entrada_usuario = input("Ingrese el nombre de la ciudad: ").lower()

nombre_similar = encontrar_nombre_similar(entrada_usuario)

if nombre_similar:
    print(nombre_similar.capitalize())  # Mostrar el nombre con la primera letra en mayúscula
else:
