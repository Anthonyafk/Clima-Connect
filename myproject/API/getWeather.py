...
def obtener_datos_del_tiempo(ciudad="Cuernavaca"):
    ...
    if request.method == "POST":
        ...
        url_origen = f"http://api.openweathermap.org/data/2.5/weather?q={ciudad_origen},{pais}&appid={api_key}"
        ...
        try:
            ...
            return render_template(
                ...
                origen=origen,
                temperatura_celsius_origen=temperatura_celsius_origen,
                humedad_origen=humedad_origen,
                descripcion_origen=descripcion_origen,
                presion_origen=presion_origen,
                ciudad_destino=ciudad_destino,
                encontrar_nombre_similar=encontrar_nombre_similar,
                descripcion_clima=descripcion_clima  # Agrega la descripción del clima
            )
